...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Employee Department</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: base_url + '/admin/emp-department/get-list',
                    type: 'POST',
                ...
                order: [[0, 'desc']],
                columns: [
                    {data: 'NAME', title: 'Employee Department Name'},
                    {data: 'CODE', title: 'Employee Department Code'},
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this notice?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/emp-department/delete/' + delete_id;
                                }
                            },
                        );
                    });

...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">State List</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 100,
                ajax: {
                    url: base_url + '/admin/state-list/get-list',
                    type: 'POST',
                ...
                order: [[0, 'asc']],
                columns: [
                    {data: 'state_id', title: 'ID'},
                    {data: 'state_name', title: 'State Name'},
                    {data: 'state_code', title: 'State Code'},
                    {data: 'union_territory', title: 'Union Territory'},
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this notice?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/state-list/delete/' + delete_id;
                                }
                            },
                        );
                    });

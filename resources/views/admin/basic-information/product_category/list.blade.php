...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Product Category</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 100,
                ajax: {
                    url: base_url + '/admin/product-category/get-list',
                    type: 'POST',
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this notice?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/product-category/delete/' + delete_id;
                                }
                            },
                        );
                    });

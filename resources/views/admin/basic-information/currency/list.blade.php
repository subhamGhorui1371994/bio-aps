...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title text-bold">Currency</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#portfolioList').DataTable({
                ...
                pageLength: 100,
                ajax: {
                    url: base_url + '/admin/currency/get-list',
                    type: 'POST',
                ...
                columns: [
                    ...
                    {data: 'PRICE_CURRENCY', title: 'PRICE CURRENCY'},
                ...
                initComplete: function (settings, json) {
                    ...
                    $('#portfolioList tbody').on('click', 'tr td .delete-action', function (e) {
                        ...
                        bootbox.confirm('Are you sure you want to delete this notice?',
                            function (result) {
                                if (result === true) {
                                    window.location.href = base_url + '/admin/currency/delete/' + delete_id;
                                }
                            },
                        );
                    });

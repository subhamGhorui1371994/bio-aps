...
class CurrencyController extends Controller
{
     ...
     * @return false|string
     */
    public function currency_list_ajax(Request $request)
    {
        $limit = $offset = 0;
        ...
        $details = Currency::getListDataTable($order_column, $order_column_by, $limit, $offset, $search);
